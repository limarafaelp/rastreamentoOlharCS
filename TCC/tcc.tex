...
\usepackage{xcolor} %Para mostrar alterações no texto
\usepackage[normalem]{ulem}
%\newcommand{\oldc}[1]{\textcolor{red}{\sout{#1}}}
%\newcommand{\newc}[1]{\textcolor{blue}{#1}}
\newcommand{\oldc}[1]{}
\newcommand{\newc}[1]{#1}
...
\input{cap-rastreamento}
\input{cap-cs}
\input{cap-homotopia}
\input{cap-cross-bouquet}
\input{cap-algoritmo-principal}
\input{cap-conclusao}
